...
inputdir=os.path.join(rootdir,"P1_hieratable","IntermediateData","extraImages","in")
intermediatedir=os.path.join(rootdir,"P1_hieratable","IntermediateData","extraImages","tmp")
outputdir=os.path.join(rootdir,"P1_hieratable","IntermediateData","extraImages","out")
