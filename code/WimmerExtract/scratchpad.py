...
mydir=r"E:\personal\EtudesEgyptologie\digitalresearch\Wimmer"
    ...
    if i==7:
        ...
        for k,c in enumerate(contours):
            ...
            if x<500 and y<500 and w>5000 and h<1000:
                ...
                print(s1)
                print(pytesseract.image_to_string(crop2))
                cropped = img[y: y+h, x: x+w]
                cv.imwrite(r"e:\personal\etudesegyptologie\sandbox\cont\c{}_{}_{}_{}_{}_{}.png".format(i,k,x,y,w,h),cropped)
                break
        """
